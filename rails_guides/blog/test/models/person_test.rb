...
class PersonTest < ActiveSupport::TestCase
  ...
  test "should not pass validation" do
    ...
    # custom messages :D
    # Invalid person object: {:name=>["your name is really strange."], :bio=>["you are full of yourself. 100 is maximum allowed."], :password=>["how can you remember password this long."], :ssn=>["are you from China?"]}
