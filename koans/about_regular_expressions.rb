...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # A: becaule they match the string with more chars when available
  ...
  def test_slash_w_is_a_shortcut_for_a_word_character_class
    ...
    assert_equal "variable_1", "variable_1 = 42"[/\w+/] # alphanumeric plus "_", same as above
  end
  ...
  # A: a character class contains a single regular expression, but multiple regular
  #    expressions can be used with alternation.
  #    E.g. [a-z0-9] vs ([a-z]|[0-9]|[EHRNL])
