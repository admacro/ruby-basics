...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # A: Array#inject applys the operation in the block to the parameter
  ...
  #
  # A: File#open without block doesn't close file.
  #    File#open do...end does close the file when the block terminates
